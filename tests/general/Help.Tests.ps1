...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\msgraphProxy\functions", "$global:testroot\..\msgraphProxy\internal\functions"),
	
	[string]
	$ModuleName = "msgraphProxy",
...
$CommandPath = @(
    "$global:testroot\..\msgraphProxy\functions"
    "$global:testroot\..\msgraphProxy\internal\functions"
)
